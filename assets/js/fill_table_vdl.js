...
$.get(
    "https://docs.google.com/spreadsheets/d/1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c/export?format=csv&id=1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c&gid=553830667", 
    function ( data ) {
        var text_entries = data.split('\r\n');
        var tbl = document.querySelector('#standard-leaderboard');
        var entry;
        for (let i = 2; i <= 17; i++) {
            entry = text_entries[i].split(',').slice(0,9);
            var text = '\n<tr><td>' + entry[0] + '</td><td>' + entry[1] + '</td><td>' + entry[2] + '</td><td>' + entry[3] + '</td><td>' + entry[4] + '</td><td>' + entry[5] + '</td><td>' + entry[6] + '</td><td>' + entry[7] + '</td><td>' + entry[8] + '</td></tr>';
...
$.get(
    "https://docs.google.com/spreadsheets/d/1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c/export?format=csv&id=1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c&gid=1205463161", 
    function ( data ) {
        var text_entries = data.split('\r\n');
        var tbl = document.querySelector('#senior-leaderboard');
        var entry;
        for (let i = 2; i <= 8; i++) {
            entry = text_entries[i].split(',').slice(0,9);
            var text = '\n<tr><td>' + entry[0] + '</td><td>' + entry[1] + '</td><td>' + entry[2] + '</td><td>' + entry[3] + '</td><td>' + entry[4] + '</td><td>' + entry[5] + '</td><td>' + entry[6] + '</td><td>' + entry[7] + '</td><td>' + entry[8] + '</td></tr>';
...
$.get(
    "https://docs.google.com/spreadsheets/d/1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c/export?format=csv&id=1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c&gid=568377742", 
    function ( data ) {
        var text_entries = data.split('\r\n');
        var tbl = document.querySelector('#female-leaderboard');
        var entry;
        for (let i = 2; i <= 6; i++) {
            entry = text_entries[i].split(',').slice(0,9);
            var text = '\n<tr><td>' + entry[0] + '</td><td>' + entry[1] + '</td><td>' + entry[2] + '</td><td>' + entry[3] + '</td><td>' + entry[4] + '</td><td>' + entry[5] + '</td><td>' + entry[6] + '</td><td>' + entry[7] + '</td><td>' + entry[8] + '</td></tr>';
...
$.get(
    "https://docs.google.com/spreadsheets/d/1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c/export?format=csv&id=1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c&gid=938080776", 
    function ( data ) {
        var text_entries = data.split('\r\n');
        var tbl = document.querySelector('#marathon');
        var entry;
        for (let i = 1; i <= 4; i++) {
...
$.get(
    "https://docs.google.com/spreadsheets/d/1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c/export?format=csv&id=1qBFIcE44w9cEtGmw8ni2GM9ikraKUxHz-6uhQTUpe1c&gid=345020600", 
    function ( data ) {
        var text_entries = data.split('\r\n');
        var tbl = document.querySelector('#second-half-marathon');
        var entry;
        for (let i = 1; i <= 6; i++) {
            entry = text_entries[i].split(',').slice(0,5);
            var text = '\n<tr><td>' + entry[0] + '</td><td>' + entry[1] + '</td><td>' + entry[2] + '</td><td>' + entry[3] + '</td><td>' + entry[4] + '</td></tr>';
...
$.get(
    ...
    function ( data ) {
        var text_entries = data.split('\r\n');
        var tbl = document.querySelector('#first-half-marathon');
        var entry;
        for (let i = 1; i <= 6; i++) {
            entry = text_entries[i].split(',').slice(0,5);
            var text = '\n<tr><td>' + entry[0] + '</td><td>' + entry[1] + '</td><td>' + entry[2] + '</td><td>' + entry[3] + '</td><td>' + entry[4] + '</td></tr>';
